...
export const Dashboard: React.FC<DashboardProps> = ({ onEntryClick, onAddEntry }) => {
    ...
    // Dynamic Greeting — memoized so it only recomputes when the hour crosses a boundary
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                ...
                <section>
                    <AnimatePresence mode="wait">
                        {currentClass ? (
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <motion.span 
                                            className="text-xs text-muted-foreground px-3 py-1 rounded-full bg-secondary/10 border border-secondary/20 whitespace-nowrap"
                            ...
                            >
                                <motion.div 
                                    className="w-16 h-16 rounded-full bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center mb-4 floating-button"
            ...
            {/* Side Column - Productivity Widgets */}
            <div className="w-full lg:w-[380px] shrink-0 space-y-6 md:space-y-8">
